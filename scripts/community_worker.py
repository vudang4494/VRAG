...
Run nightly via cron or `make pipeline-community`.

Usage:
  # Build for one tenant
  python3 scripts/community_worker.py --tenant default --api http://localhost:8800

  # Dry-run: show how many entities but don't build
  python3 scripts/community_worker.py --tenant default --dry-run
"""
