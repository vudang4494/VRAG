...
async def ollama_chat(
    ...
    extra_options: passed through to the request body. Use {"format": "json"} for
    JSON-mode generation. Caller-supplied keys take precedence over defaults.
    """
    ...
    for attempt in range(_retries):
        try:
            ...
            if extra_options:
                # Merge: top-level keys (e.g. "format") go to body; nested under
                # "options" key get merged into body["options"].
